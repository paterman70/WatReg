        ...
        Try
            For Each marray In Foreas
                Try
                    ...
                    '"?><decisionresults>
                    '<decision>
                    '<ada>6ΦΙΨΟΡ1Υ-4Ο4</ada>
                    '<decisionTypeLabel>ΛΟΙΠΕΣ ΑΤΟΜΙΚΕΣ ΔΙΟΙΚΗΤΙΚΕΣ ΠΡΑΞΕΙΣ</decisionTypeLabel>
                    '<decisionTypeUid>2.4.7.1</decisionTypeUid>
                    '<documentUrl>https://diavgeia.gov.gr/doc/6ΦΙΨΟΡ1Υ-4Ο4</documentUrl>
                    '<issueDate>14/07/2020 03:00:00</issueDate>
                    '<organizationLabel>ΑΠΟΚΕΝΤΡΩΜΕΝΗ ΔΙΟΙΚΗΣΗ ΜΑΚΕΔΟΝΙΑΣ – ΘΡΑΚΗΣ</organizationLabel>
                    '<organizationUid>50205</organizationUid>
                    '<protocolNumber>25355</protocolNumber>
                    '<subject>«Χορήγηση άδειας χρήσης νερού στον ...».</subject>
